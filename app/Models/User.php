...
class User extends Authenticatable  
{
    ...
    public function getProgress()
    {
        ...
        $fieldObject = [
            ...
            'address' => ['address', 'city', 'province', 'subdistrict', 'district', 'country', 'postal_code', 'rt', 'rw', 'phone_number', 'phone_number_alt'],
            'education' => ['last_education', 'education_number', 'education_name', 'education_city', 'education_province', 'education_subdistrict', 'education_country', 'education_postal_code', 'education_graduation_year', 'education_major'],
            'parent' => ['father_name', 'father_birth_date', 'father_place', 'father_last_education', 'father_job', 'father_phone', 'mother_name', 'mother_birth_date', 'mother_place', 'mother_last_education', 'mother_job', 'mother_phone'],
            'document' => ['ktp', 'kk', 'foto'],
        ];
